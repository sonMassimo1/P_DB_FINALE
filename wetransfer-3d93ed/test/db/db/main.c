...
//  db
//
//  Created by Massimo Mazzetti on 10/06/2020.
//  Copyright © 2020 Massimo Mazzetti. All rights reserved.
//
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void) {
    ...
    if (mysql_real_connect(conn, "localhost", "root", "root1234", "mydb", 3306, NULL, CLIENT_MULTI_STATEMENTS | CLIENT_MULTI_RESULTS) == NULL) {
